...
export function PageRenderer({ dictionary, route }: PageRendererProps) {
	...
	if (route.kind === "legal") return <LegalPage dictionary={dictionary} locale={locale} page={route.page} />;

	return <PortfolioPage dictionary={dictionary} locale={locale} showSideProjects={route.kind === "locale"} />;
}
