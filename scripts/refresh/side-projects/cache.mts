...
import { readJsonFile } from "@/scripts/refresh/side-projects/snapshot.mts";
import { createGeneratedSideProject, isGitHubRepository } from "@/scripts/refresh/side-projects/validation.mts";
