...
import { buildSnapshot, readConfiguration, readSnapshot, writeSnapshot } from "./side-projects/snapshot.mjs";
...
export { createGeneratedSideProject, isGitHubRepository } from "./side-projects/validation.mjs";
