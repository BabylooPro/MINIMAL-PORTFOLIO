...
| Site controller gzip                 | 3,847 B | ≤ 3,900 B | ✅ PASS |
| Root executable JavaScript gzip      | 4,495 B | ≤ 4,600 B | ✅ PASS |
| Localized executable JavaScript gzip | 4,202 B | ≤ 4,300 B | ✅ PASS |
...
| /en/  | 8,984 B | ≤ 10,000 B | ✅ PASS |
| /fr/  | 9,288 B | ≤ 10,000 B | ✅ PASS |
| /de/  | 9,255 B | ≤ 10,000 B | ✅ PASS |

## Secondary HTML

| Route        | Current | Budget     | Status  |
| ------------ | ------- | ---------- | ------- |
| /404.html    | 4,041 B | ≤ 10,000 B | ✅ PASS |
| /de/404.html | 4,093 B | ≤ 10,000 B | ✅ PASS |
| /de/legal/   | 4,900 B | ≤ 10,000 B | ✅ PASS |
| /de/privacy/ | 5,684 B | ≤ 10,000 B | ✅ PASS |
| /en/404.html | 4,041 B | ≤ 10,000 B | ✅ PASS |
| /en/legal/   | 4,771 B | ≤ 10,000 B | ✅ PASS |
| /en/privacy/ | 5,376 B | ≤ 10,000 B | ✅ PASS |
| /fr/404.html | 4,121 B | ≤ 10,000 B | ✅ PASS |
| /fr/legal/   | 4,931 B | ≤ 10,000 B | ✅ PASS |
| /fr/privacy/ | 5,744 B | ≤ 10,000 B | ✅ PASS |
