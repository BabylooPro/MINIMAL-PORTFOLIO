...
export const deMessages = {
	meta: {
		...
		ogDescription: "Autodidaktischer freiberuflicher Entwickler in Waadt, Schweiz, mit 10 Jahren Erfahrung.",
	...
	legalPages: {
		...
		privacy: {
			title: "Datenschutz",
			description: "Wie dieses Portfolio technische Einstellungen und Kontaktdaten verarbeitet.",
			intro: "Dieses Portfolio bietet kein Konto, kein Kontaktformular, kein Reichweitenmessungs-Tool und keinen Werbetracker.",
			themeTitle: "Theme-Einstellung",
			themeDescription: "Die Auswahl von System, Hell oder Dunkel speichert nur diese Einstellung im lokalen Speicher Ihres Browsers. Die Website übermittelt diese Einstellung nicht an Max Remy Dev.",
			...
			contactDescription:
				"Max Remy Dev, ein Einzelunternehmen von Max Remy mit Sitz an der Avenue de Cerjat 9, 1510 Moudon, Schweiz, ist für die Datenbearbeitung verantwortlich. Wenn Sie eine E-Mail senden, erhält Max Remy Dev Ihre Nachricht über Gmail (Google), den verwendeten E-Mail-Anbieter. Ihr eigener E-Mail-Anbieter ist ebenfalls an der Übermittlung beteiligt.",
			emailProviderPrivacyPolicyLabel: "Datenschutzerklärung von Google",
			rightsTitle: "Ihre Rechte",
			rightsDescription: "Sie können Auskunft, Berichtigung oder Löschung Ihrer personenbezogenen Daten verlangen oder deren Bearbeitung widersprechen, indem Sie an die oben genannte E-Mail-Adresse schreiben.",
			...
			updatesDescription: "Diese Seite wird aktualisiert, bevor eine neue Funktion eine zusätzliche Bearbeitung personenbezogener Daten oder einen Drittanbieter-Dienst einführt.",
		},
		legal: {
			title: "Impressum",
			description: "Herausgeber, Kontakt und Informationen zu den Inhalten von maxremy.dev.",
			publisherTitle: "Herausgeber",
			publisherDescription: "Dieses Portfolio wird von Max Remy Dev, einem Schweizer Einzelunternehmen von Max Remy, veröffentlicht.",
			businessInformation: {
				...
				addressValue: "Avenue de Cerjat 9, 1510 Moudon, Schweiz",
			...
			responsibilityTitle: "Verantwortung für Inhalte",
			responsibilityDescription: "Max Remy ist für die auf diesem Portfolio veröffentlichten Inhalte verantwortlich.",
			intellectualPropertyTitle: "Geistiges Eigentum",
			intellectualPropertyDescription: "Der Quellcode dieses Portfolios steht unter der MIT-Lizenz. Sofern nicht anders angegeben, fallen Texte, Design, Fotografien, Lebenslauf und andere visuelle Elemente nicht unter diese Lizenz und dürfen ohne vorherige Genehmigung nicht wiederverwendet werden.",
			sourceCodeLicenseLabel: "Quellcode: MIT-Lizenz",
			externalLinksTitle: "Externe Links",
			externalLinksDescription: "Max Remy Dev hat keinen Einfluss auf Inhalte oder Datenbearbeitung von verlinkten Websites Dritter.",
		},
	},
	proofWork: {
		description: "Echte Entwicklungssessions, in denen ich den Code selbst schreibe, verdichtet zu ultraschnellen Zeitraffern. Ich nutze darin wenig bis keine KI, einfach, um das gute alte Gefühl wiederzufinden :)\n\nLangsamere Versionen gibt es auf meinem YouTube-Kanal.",
		summary: "Zeitraffer von echten Entwicklungssessions.",
		postscript: "P.S. Außerhalb dieser Videos nutze ich agentische KI, um schneller voranzukommen, aber niemals für „Vibe Coding“. Denken, Architektur, Code und technische Entscheidungen bleiben bei mir.",
