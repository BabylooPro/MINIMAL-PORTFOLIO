...
export const enMessages = {
	meta: {
		...
		ogDescription: "Self-taught freelance developer based in Vaud, Switzerland, with 10 years of experience.",
	...
	legalPages: {
		...
		privacy: {
			...
			themeDescription: "Choosing System, Light, or Dark stores only that preference in your browser's local storage. The site does not send that preference to Max Remy Dev.",
			...
			rightsDescription: "You may request access to, correction, or deletion of your personal data, or object to its processing, by writing to the email address above.",
			...
			updatesDescription: "This page will be updated before a new feature introduces additional personal-data processing or a third-party service.",
		},
		legal: {
			title: "Legal notice",
			description: "Publisher, contact, and content information for maxremy.dev.",
			publisherTitle: "Publisher",
			publisherDescription: "This portfolio is published by Max Remy Dev, a Swiss sole proprietorship owned by Max Remy.",
			businessInformation: {
			...
			responsibilityDescription: "Max Remy is responsible for the content published on this portfolio.",
			intellectualPropertyTitle: "Intellectual property",
			intellectualPropertyDescription: "This portfolio's source code is available under the MIT License. Unless stated otherwise, the text, design, photographs, CV, and other visual assets are not covered by that license and may not be reused without prior permission.",
			sourceCodeLicenseLabel: "Source code: MIT License",
			externalLinksTitle: "External links",
			externalLinksDescription: "Max Remy Dev has no control over the content or data processing of linked third-party websites.",
		},
	},
	proofWork: {
		description: "Real development sessions where I write the code myself, condensed into ultra-fast timelapses. I use little to no AI in them, just to relive the good old days :)\n\nSlower versions are available on my YouTube channel.",
		summary: "Timelapses of real development sessions.",
		postscript: "P.S. Outside these videos, I do use agentic AI to move faster, but never to “vibe code”. I stay in charge of the thinking, architecture, code, and technical decisions.",
